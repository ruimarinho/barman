...
class AwsCloudSnapshotInterface(CloudSnapshotInterface):
    ...
    def __init__(
            self, profile_name=None, region=None, await_snapshots_timeout=3600,
            lock_mode=None, lock_duration=None, cool_off_period=None, expiration_date=None
        ):
        """
        ...
        :param int lock_duration: The duration (in days) for which the snapshot
            should be locked.
        :param int cool_off_period: The cool-off period (in hours) for the snapshot.
        :param str expiration_date: The expiration date for the snapshot in the format
    ...
    def _lock_snapshots(self, snapshots, lock_mode, lock_duration, cool_off_period, expiration_date):
        ...
        if cool_off_period:
            lock_snapshot_default_args["CoolOffPeriod"] = cool_off_period

        if expiration_date:
            lock_snapshot_default_args["ExpirationDate"] = expiration_date
        ...
        for snapshot in snapshots:
            ...
            logging.info("Snapshot %s locked in state '%s' (lock duration: %s days, cool-off period: %s hours, cool-off period expires on: %s, lock expires on: %s, lock duration time: %s) ",
                snapshot.identifier,
                resp["LockState"],
                resp["CoolOffPeriod"],
...
class AwsSnapshotsInfo(SnapshotsInfo):
    ...
    def __init__(self, snapshots=None, account_id=None, region=None, lock_mode=None, lock_duration=None, expiration_date=None):
        """
